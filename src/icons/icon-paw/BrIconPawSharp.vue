<template>
  ...
  >
    <path
      ...
      :style="{ fill: color }"
    />
    <ellipse cx="72" cy="216" rx="56" ry="72" :style="{ fill: color }" />
    <ellipse cx="184" cy="120" rx="56" ry="72" :style="{ fill: color }" />
    <ellipse cx="328" cy="120" rx="56" ry="72" :style="{ fill: color }" />
    <ellipse cx="440" cy="216" rx="56" ry="72" :style="{ fill: color }" />
  </svg>
</template>
