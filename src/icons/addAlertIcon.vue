<template>
  ...
  >
    ...
    <path
      d="M15.984 13.031v-2.016h-3v-3h-1.969v3h-3v2.016h3v3h1.969v-3h3zM18.891 16.828l2.109 2.109v1.078h-18v-1.078l2.109-2.109v-5.813q0-2.25 1.547-4.219t3.75-2.484v-0.703q0-0.656 0.469-1.125t1.125-0.469 1.125 0.469 0.469 1.125v0.703q2.297 0.516 3.797 2.414t1.5 4.289v5.813zM10.031 21h3.938q0 0.797-0.586 1.406t-1.383 0.609-1.383-0.609-0.586-1.406z"
    ></path>
  </svg>
</template>
