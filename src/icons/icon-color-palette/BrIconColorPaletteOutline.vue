<template>
  ...
  >
    <path
      ...
      :style="{ stroke: color }"
    />
    <circle cx="144" cy="208" r="32" :style="{ fill: color }" />
    <circle cx="152" cy="311" r="32" :style="{ fill: color }" />
    <circle cx="224" cy="144" r="32" :style="{ fill: color }" />
    <circle cx="256" cy="367" r="48" :style="{ fill: color }" />
    <circle cx="328" cy="144" r="32" :style="{ fill: color }" />
  </svg>
</template>
...
export default defineComponent({
  name: 'BrIconColorPaletteOutline',
  props: {
    color: {
      type: String,
