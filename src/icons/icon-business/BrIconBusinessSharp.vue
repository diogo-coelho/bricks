<template>
  ...
  >
    <path
      ...
      :style="{ fill: color }"
    />
    <rect x="384" y="400" width="32" height="32" :style="{ fill: color }" />
    <rect x="384" y="320" width="32" height="32" :style="{ fill: color }" />
    <rect x="384" y="240" width="32" height="32" :style="{ fill: color }" />
  </svg>
</template>
