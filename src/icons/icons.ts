...
import BrIconCheckCircleOutline from './icon-check-circle-outline/BrIconCheckCircleOutline.vue'
import BrIconCircle from './icon-circle/BrIconCircle.vue'
import BrIconClear from './icon-clear/BrIconClear.vue'
import BrIconDirectionsBike from './icon-directions-bike/BrIconDirectionsBike.vue'
import BrIconErrorOutline from './icon-error-outline/BrIconErrorOutline.vue'
import BrIconInfoOutline from './icon-info-outline/BrIconInfoOutline.vue'
