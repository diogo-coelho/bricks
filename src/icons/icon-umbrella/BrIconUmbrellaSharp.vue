<template>
  <svg
    ...
    viewBox="0 0 512 512"
  >
    <path d="M128.93,280l-.26-.3c-.9-.74-1.83-1.43-2.77-2.1Z" :style="{fill:color}" />
    <path d="M383.08,280l2.62-2.12c-.79.58-1.57,1.17-2.34,1.79Z"  :style="{fill:color}" />
    <path
