<template>
  ...
  >
    <path
      ...
      :style="{ stroke: color }"
    />
    <circle cx="160" cy="216" r="32" :style="{ fill: color }" />
    <circle cx="256" cy="216" r="32" :style="{ fill: color }" />
    <circle cx="352" cy="216" r="32" :style="{ fill: color }" />
  </svg>
</template>
...
export default defineComponent({
  name: 'BrIconChatboxEllipsesOutline',
  props: {
    color: {
      type: String,
