<template>
  ...
  >
    <path
      ...
      :style="{ stroke: color }"
    />
    <circle cx="292" cy="224" r="20" :style="{ fill: color }" />
    <path
      d="M336,288a20,20,0,1,1,20-19.95A20,20,0,0,1,336,288Z"
      :style="{ fill: color }"
    />
    <circle cx="336" cy="180" r="20" :style="{ fill: color }" />
    <circle cx="380" cy="224" r="20" :style="{ fill: color }" />
    <line
      x1="160"
      y1="176"
      x2="160"
...
export default defineComponent({
  name: 'BrIconGameControllerOutline',
  props: {
    color: {
      type: String,
